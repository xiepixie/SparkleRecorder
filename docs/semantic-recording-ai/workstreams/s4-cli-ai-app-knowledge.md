...
## Accepted CLI guidance contract (2026-09-05)

S4 requests and accepts repository-free reconstruction help, additive optional JSON `usage`, and export/import next-step guidance. Playback and acceptance stay in the existing S3 interface; no S1 semantics change. [Contract and CLI coverage](../23-cli-user-flow.md) names direct tests and the integration boundary.
