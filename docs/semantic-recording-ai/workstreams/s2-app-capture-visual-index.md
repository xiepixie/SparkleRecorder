...
- 普通宏录制流程中接入 `SemanticRecordingLifecycle`
...
1. Wire `SemanticRecordingLifecycle` into the existing recording lifecycle behind a feature flag or internal entry point.
