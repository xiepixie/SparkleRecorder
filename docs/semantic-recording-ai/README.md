...
- [17-ai-assisted-macro-reconstruction-design.md](17-ai-assisted-macro-reconstruction-design.md)：已接受但尚未实现的 AI 宏重建设计；以清洗后的 `SavedMacro` 作为操作骨架、MP4 作为视觉状态事实，补齐帧级时钟对齐和操作还原轨道，允许 AI 完整重写候选宏，并通过本地校验、一键试跑、原版本恢复和用户接受完成晋升。
