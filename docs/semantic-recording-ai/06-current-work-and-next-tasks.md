...
1. Product UX closure: first text-target readiness polish is in progress; next, OCR/visual region picker should show a region box for wait/verify actions and reserve click circles for click actions only.
