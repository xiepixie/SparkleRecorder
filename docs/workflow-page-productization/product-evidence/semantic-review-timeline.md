...
- Checklist item: S3 fixture Review projection, interactive Review UI, source/runtime evidence drill-in, evidence-backed suggestion review decisions and frame-to-condition patch affordance
