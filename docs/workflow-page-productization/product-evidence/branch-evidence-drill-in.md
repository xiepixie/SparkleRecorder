...
- Known gaps: this is a fixture screenshot rather than a live recording; drag-link, task-reorder, failed-run-detail, and visual diagnostics fixture artifacts now exist, while full live drag/reorder and live branch workflow recording remain open.
