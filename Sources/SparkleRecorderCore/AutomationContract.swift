  ...
  public func validationIssues() -> [AutomationWorkflowValidationIssue] {
    ...
    for dependency in dependencies {
      ...
      if !taskIDSet.contains(dependency.fromTaskID) {
        issues.append(
          .missingDependencySource(dependencyID: dependency.id, taskID: dependency.fromTaskID))
      }
      if !taskIDSet.contains(dependency.toTaskID) {
        issues.append(
          .missingDependencyTarget(dependencyID: dependency.id, taskID: dependency.toTaskID))
      }
    }

    issues.append(
      contentsOf: cycleIssues(taskIDs: taskIDSet, dependencies: dependencies.filter(\.isEnabled)))
    return issues
  }
}
...
public enum AutomationTargetApplicationCleanupPolicy: String, Codable, Equatable, Sendable,
  CaseIterable
{
  case keepOpen
  case quitIfLaunched
...
public struct AutomationTask: Codable, Equatable, Sendable, Identifiable {
  ...
  private enum CodingKeys: String, CodingKey {
    ...
    case targetApplicationReadyDelay
    case targetApplicationCleanupPolicy
    case targetApplicationQuitTimeout
    case targetApplicationForceQuitOnTimeout
    case playbackLoops
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.timeout = try container.decodeIfPresent(TimeInterval.self, forKey: .timeout).map {
      max(0, $0)
    }
    self.retryPolicy =
      try container.decodeIfPresent(AutomationRetryPolicy.self, forKey: .retryPolicy) ?? .none
    self.joinPolicy =
      try container.decodeIfPresent(AutomationJoinPolicy.self, forKey: .joinPolicy) ?? .all
    self.isEnabled = try container.decodeIfPresent(Bool.self, forKey: .isEnabled) ?? true
    self.targetApplicationPolicy =
      try container.decodeIfPresent(
        AutomationTargetApplicationPolicy.self,
        forKey: .targetApplicationPolicy
      ) ?? .activateIfRunning
    self.targetApplicationReadyDelay = min(
      60,
      max(
        0,
        try container.decodeIfPresent(
          TimeInterval.self,
          forKey: .targetApplicationReadyDelay
        ) ?? 0))
    self.targetApplicationCleanupPolicy =
      try container.decodeIfPresent(
        AutomationTargetApplicationCleanupPolicy.self,
        forKey: .targetApplicationCleanupPolicy
      ) ?? .keepOpen
    self.targetApplicationQuitTimeout = min(
      60,
      max(
        1,
        try container.decodeIfPresent(
          TimeInterval.self,
          forKey: .targetApplicationQuitTimeout
        ) ?? 5))
    self.targetApplicationForceQuitOnTimeout =
      try container.decodeIfPresent(
        Bool.self,
        forKey: .targetApplicationForceQuitOnTimeout
      ) ?? true
    self.playbackLoops = try container.decodeIfPresent(Int.self, forKey: .playbackLoops).map {
      max(1, $0)
    }
    self.missedRunPolicy =
      try container.decodeIfPresent(
        AutomationMissedRunPolicy.self,
        forKey: .missedRunPolicy
      ) ?? .catchUp
    self.graphPosition = try container.decodeIfPresent(
      AutomationGraphPoint.self, forKey: .graphPosition)
  }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(targetApplicationReadyDelay, forKey: .targetApplicationReadyDelay)
    try container.encode(targetApplicationCleanupPolicy, forKey: .targetApplicationCleanupPolicy)
    try container.encode(targetApplicationQuitTimeout, forKey: .targetApplicationQuitTimeout)
    try container.encode(
      targetApplicationForceQuitOnTimeout, forKey: .targetApplicationForceQuitOnTimeout)
...
public struct AutomationOCRSearchRegionSelection: Equatable, Sendable {
  ...
  private func region(in frame: RectValue?, normalized: Bool) -> RectValue? {
    guard let frame,
      let clipped = selectedDisplayRegion.intersection(with: frame)
    else {
      return nil
    }
...
public struct AutomationOCRCondition: Codable, Equatable, Sendable {
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.matchMode =
      try container.decodeIfPresent(TextMatchMode.self, forKey: .matchMode) ?? .contains
    self.searchRegion = try container.decodeIfPresent(RectValue.self, forKey: .searchRegion)
    self.searchRegionSpace =
      try container.decodeIfPresent(
...
public struct AutomationVisualCondition: Codable, Equatable, Sendable {
  ...
  public init(
    ...
    self.type = type
    self.regionRef =
      regionRef?.trimmingCharacters(in: .whitespacesAndNewlines).nilIfEmptyForAutomationCondition
    self.searchRegion = searchRegion
    self.searchRegionSpace = searchRegionSpace
    self.imageRef =
      imageRef?.trimmingCharacters(in: .whitespacesAndNewlines).nilIfEmptyForAutomationCondition
    self.baselineRef =
      baselineRef?.trimmingCharacters(in: .whitespacesAndNewlines).nilIfEmptyForAutomationCondition
    self.pixel = pixel
    self.targetColorHex =
      targetColorHex?.trimmingCharacters(in: .whitespacesAndNewlines)
      .nilIfEmptyForAutomationCondition
...
extension String {
  fileprivate var nilIfEmptyForAutomationCondition: String? {
    isEmpty ? nil : self
  }

  fileprivate var nilIfEmptyForDynamicDependencyDelay: String? {
    isEmpty ? nil : self
  }
}
...
extension RectValue {
  ...
  fileprivate func offset(by frame: RectValue) -> RectValue {
    RectValue(
      x: frame.x + x,
      y: frame.y + y,
      width: width,
  ...
  fileprivate func denormalized(in frame: RectValue) -> RectValue {
    RectValue(
  ...
  fileprivate func intersection(with frame: RectValue) -> RectValue? {
  ...
  fileprivate func local(in frame: RectValue) -> RectValue {
    RectValue(
      x: x - frame.x,
      y: y - frame.y,
      width: width,
  ...
  fileprivate func normalized(in frame: RectValue) -> RectValue {
    RectValue(
...
public enum AutomationOutcomePredicate: String, Codable, Equatable, Sendable {
  ...
  public func matches(_ outcome: AutomationOutcome) -> Bool {
    ...
    case (.success, .succeeded):
      return true
    case (.failure, .failed), (.failure, .resourceConflict), (.failure, .permissionDenied),
      (.failure, .missingMacro), (.failure, .rejected):
      return true
...
public enum AutomationRunEvidenceArtifactStatus: String, Codable, Equatable, Sendable {
  case persisted
  case unavailable
  case failed
}

public enum AutomationRunEvidenceHealth: String, Codable, Equatable, Sendable {
  case persisted
  case partial
  case failed
}

public struct AutomationRunEvidencePersistence: Codable, Equatable, Sendable {
  public var evidenceID: UUID
  public var report: AutomationRunEvidenceArtifactStatus
  public var screenshot: AutomationRunEvidenceArtifactStatus
  public var manifest: AutomationRunEvidenceArtifactStatus
  public var recordedAt: Date
  public var failureMessage: String?

  public init(
    evidenceID: UUID,
    report: AutomationRunEvidenceArtifactStatus,
    screenshot: AutomationRunEvidenceArtifactStatus,
    manifest: AutomationRunEvidenceArtifactStatus,
  ...
  public var health: AutomationRunEvidenceHealth {
    guard report == .persisted else { return .failed }
    guard manifest == .persisted, screenshot == .persisted else { return .partial }
    return .persisted
  }

  public var hasReadableReport: Bool {
    report == .persisted
  }
}
...
public struct AutomationConditionEvaluationEvidence: Codable, Equatable, Sendable, Identifiable {
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.init(
      ...
      resolvedSearchRegion: try container.decodeIfPresent(
        RectValue.self, forKey: .resolvedSearchRegion),
...
public enum AutomationConditionEvidenceDurationParser {
  ...
  private static func unitDuration(in text: String) -> ParsedDuration? {
    ...
    return ParsedDuration(
      duration: total, sourceText: text.trimmingCharacters(in: .whitespacesAndNewlines))
  }
  ...
  private static func colonDuration(in text: String) -> ParsedDuration? {
    ...
    guard let match = regex.firstMatch(in: text, options: [], range: range),
      ...
      let second = doubleValue(in: nsText, match: match, group: 3)
    else {
      return nil
    }
  ...
  private static func doubleValue(in text: NSString, match: NSTextCheckingResult, group: Int)
    -> Double?
  {
...
extension AutomationDependency {
  public func delayResolution(after sourceRun: AutomationTaskRun)
    -> AutomationDependencyDelayResolution
  {
    ...
    case .conditionEvidenceDuration:
      ...
      guard
        let parsed = AutomationConditionEvidenceDurationParser.duration(
          in: evidence,
...
public struct AutomationTaskRun: Codable, Equatable, Sendable, Identifiable {
  ...
  public var outcome: AutomationOutcome?
  public var evidenceID: UUID?
  public var evidencePersistence: AutomationRunEvidencePersistence?
  ...
  public var interruption: AutomationRunInterruption?
  public var artifactRetention: AutomationRunArtifactRetention?
  ...
  public init(
    ...
    evidenceID: UUID? = nil,
    evidencePersistence: AutomationRunEvidencePersistence? = nil,
    leaseID: UUID? = nil,
    createdAt: Date = Date.now,
    attempt: Int = 1,
    upstreamRunIDs: [UUID] = [],
    ...
    interruption: AutomationRunInterruption? = nil,
    artifactRetention: AutomationRunArtifactRetention? = nil
  ) {
    self.id = id
...
public struct AutomationRunInterruption: Codable, Equatable, Sendable {
  public var previousStatus: AutomationTaskRunStatus
  public var detectedAt: Date
  public var reason: String

  public init(
    previousStatus: AutomationTaskRunStatus,
    detectedAt: Date,
    reason: String
  ) {
...
public enum AutomationRunArtifactRetentionStatus: String, Codable, Equatable, Sendable {
  case pendingDeletion
  case pruned
}

public struct AutomationRunArtifactRetention: Codable, Equatable, Sendable {
  public var status: AutomationRunArtifactRetentionStatus
  public var requestedAt: Date
  public var completedAt: Date?
  public var originalEvidenceID: UUID?
  public var deletedRelativePaths: [String]

  public init(
    status: AutomationRunArtifactRetentionStatus,
    requestedAt: Date,
    completedAt: Date? = nil,
    originalEvidenceID: UUID? = nil,
    deletedRelativePaths: [String] = []
  ) {
    self.status = status
    self.requestedAt = requestedAt
    self.completedAt = completedAt
    self.originalEvidenceID = originalEvidenceID
    self.deletedRelativePaths = deletedRelativePaths
  }
}

public enum AutomationPersistenceOperation: String, Codable, Equatable, Sendable {
  case workflows
  case runCheckpoint
}

public struct AutomationPersistenceIssue: Codable, Equatable, Identifiable, Sendable {
  public var id: UUID
  public var operation: AutomationPersistenceOperation
  public var runID: UUID?
  ...
  public init(
    id: UUID = UUID(),
    operation: AutomationPersistenceOperation,
    runID: UUID? = nil,
    message: String,
    failedAt: Date
  ) {
...
public enum AutomationAction: Codable, Equatable, Sendable {
  ...
  case manualStartWorkflow(workflowID: UUID, requestedAt: Date)
  ...
  case evidencePersistenceUpdated(
    runID: UUID,
    persistence: AutomationRunEvidencePersistence,
    at: Date
  )
  ...
  case conditionEvaluationCompleted(
    runID: UUID, result: AutomationConditionEvaluationResult, at: Date)
  ...
  case persistenceSucceeded(operation: AutomationPersistenceOperation, runID: UUID?, at: Date)
  case persistenceFailed(AutomationPersistenceIssue)
}
...
private func cycleIssues(
  ...
  for dependency in dependencies
  where taskIDs.contains(dependency.fromTaskID) && taskIDs.contains(dependency.toTaskID) {
