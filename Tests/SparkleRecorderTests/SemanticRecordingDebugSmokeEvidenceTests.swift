...
struct SemanticRecordingDebugSmokeEvidenceTests {
    ...
    func finishedSidecarCapturesBundleCountsAndRedactionPaths() throws {
        ...
        #expect(markdown.contains("- decision rows: nextStep=Next step: Start the next recording"))
    ...
    func blockedSidecarRecordsPreflightIssuesWithoutBundlePaths() throws {
        ...
        #expect(markdown.contains("- decision rows: nextStep=Next step: Open the blocked permission rows below"))
